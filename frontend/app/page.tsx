    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <Card title="ATM Risk Dashboard" subtitle={`Strike ${atmRow.strike} Call`}>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <GreekGauge symbol="Δ" label="Delta" value={atmRow.delta} min={0} max={1} color="hsl(160, 60%, 45%)" decimals={3} />
          <GreekGauge symbol="Γ" label="Gamma" value={atmRow.gamma} min={0} max={0.005} color="#437DFB" decimals={4} />
          <GreekGauge symbol="Θ" label="Theta/day" value={atmRow.theta} min={-20} max={0} color="#D93036" decimals={2} />
          <GreekGauge symbol="ν" label="Vega" value={atmRow.vega} min={0} max={30} color="hsl(30, 80%, 55%)" decimals={2} />
        </div>
      </Card>
